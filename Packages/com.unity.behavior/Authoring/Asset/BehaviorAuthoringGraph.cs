...
#pragma warning disable CS0618 // OnOpenAsset still supplies the legacy int identifier.
            var entityId = (EntityId)instanceID;
#pragma warning restore CS0618
            BehaviorAuthoringGraph asset = EditorUtility.EntityIdToObject(entityId) as BehaviorAuthoringGraph;
#else
            ...
            {
#if UNITY_6000_5_OR_NEWER
                BehaviorGraph runtimeGraph = EditorUtility.EntityIdToObject(entityId) as BehaviorGraph;
#else
